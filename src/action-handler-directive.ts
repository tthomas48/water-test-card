...
customElements.define('action-handler-water-test', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-water-test')) {
    return body.querySelector('action-handler-water-test') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-water-test');
