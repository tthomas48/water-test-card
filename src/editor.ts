...
import { WaterTestCardConfig } from './types';
...
@customElement('water-test-card-editor')
export class WaterTestCardEditor extends LitElement implements LovelaceCardEditor {
  @property({ attribute: false }) public hass?: HomeAssistant;
  @internalProperty() private _config?: WaterTestCardConfig;
